...
public class QueueCommandInit extends ChannelInitializer<SocketChannel> {
	...
	static QueueCommandHandler queueCommandHandler;
	...
	public QueueCommandInit(RoutingConf conf, boolean enableCompression, Queue<CommandMessage> leaderMessageQue, Queue<CommandMessage> nonLeaderMessageQue) {
		...
		queueCommandHandler = new QueueCommandHandler(conf, leaderMessageQue, nonLeaderMessageQue);

	}
	
	public QueueCommandHandler getCommandHandler(){
	...
	public void initChannel(SocketChannel ch) throws Exception {
		...
		pipeline.addLast("handler", new QueueCommandHandler());
	}
}
